...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">PPA Raffle</a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('draw') }}">Draw</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('listwinners') }}">List of Winners</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('uploads') }}">Upload</a>
      </li>
    </ul>
